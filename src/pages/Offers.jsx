      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-10">
          {offers.map((offer) => (
            <div
              key={offer.id}
              className={`rounded-3xl p-6 text-white bg-gradient-to-br ${offer.bgGradient} shadow-xl border border-amber-500/20 flex flex-col justify-between relative overflow-hidden group`}
            >

  ...
  return (
    <footer className="bg-[#0F2C23] text-stone-300 pt-8 pb-4 border-t-2 border-amber-500/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 pb-6 border-b border-emerald-800/40">
          ...
          <div className="lg:col-span-2 space-y-2">
            ...
            <p className="text-xs text-stone-300/80 max-w-sm leading-relaxed">
            ...
            <div className="pt-1 flex items-center space-x-2 text-[11px] text-amber-300/90 font-medium">
          ...
          <div>
            <h4 className="font-serif text-sm font-semibold text-amber-200 tracking-wider mb-2 border-b border-amber-500/20 pb-0.5 inline-block">
              Hapsman
            </h4>
          ...
          <div>
            ...
            <div className="mt-3 pt-2 border-t border-emerald-800/40 space-y-1 text-[11px] text-amber-200 font-medium">
              <span className="text-stone-400 font-bold block uppercase tracking-wider text-[9px]">Helplines:</span>
              <div className="space-y-0.5 font-mono text-[11px]">
                <a href="tel:9653129079" className="block hover:text-amber-400 transition-colors">📞 +91 9653129079</a>
        ...
        <div className="py-3 border-b border-emerald-800/40 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-stone-300">
          <div className="flex items-center space-x-1.5 text-[11px]">
            <MapPin className="w-3.5 h-3.5 text-amber-400 shrink-0" />
            <div>
              <span className="font-semibold text-amber-200">Manufactured by: </span>
              <span>Nature Agro Harvest Private Limited, Gauriganj, Amethi, UP, India.</span>
            </div>
          </div>
        ...
        <div className="pt-3 flex flex-col sm:flex-row items-center justify-between text-[11px] text-stone-400 gap-2 border-t border-emerald-800/30">
